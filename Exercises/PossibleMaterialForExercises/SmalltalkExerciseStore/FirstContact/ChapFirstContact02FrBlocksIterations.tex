...
A partir du tableau {\bf constant} de symboles  ayant le nom
d'une couleur, construire un tableau des noms de couleur
ne commen\c{c}ant pas par un \ct{d}\\
...
sonner la cloche (\ct{Screen default ringBell}) si c'est vrai.
\item
...
~\\
Exemple~: \ct{tab := (1 to: 100)} cr\'ee un tableau des 100 premiers entiers.
